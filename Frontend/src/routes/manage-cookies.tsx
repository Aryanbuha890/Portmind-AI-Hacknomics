      ...
      <div className="mx-auto max-w-4xl px-6 py-12 md:py-20">
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-slate-600">Manage your cookie preferences and learn how we use trackers.</p>
          </div>

          <div className="prose prose-invert prose-orange max-w-none text-slate-700">
            <p>
            ...
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4 border-b border-slate-200 pb-2">What are Cookies?</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4 border-b border-slate-200 pb-2">Types of Cookies We Use</h2>
            ...
            <div className="space-y-6 mt-4">
              ...
              <div className="bg-slate-100 p-5 rounded-xl border border-slate-200 opacity-75">
                <h3 className="text-lg font-medium text-slate-900 flex items-center justify-between">
            ...
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4 border-b border-slate-200 pb-2">Your Choices Regarding Cookies</h2>
            <p>
              If you prefer to avoid the use of cookies on the Website, first you must disable the use of cookies in your browser and then delete the cookies saved in your browser associated with this website. You may use this option for preventing the use of cookies at any time.
            </p>

            <div className="bg-slate-100 p-4 rounded-xl border border-slate-200 mt-8 flex flex-col sm:flex-row gap-4 justify-between items-center">
              <div>
                <p className="font-semibold text-slate-900">Need help managing your cookies?</p>
                <p className="text-slate-600 text-sm">Our support team can assist you with your privacy preferences.</p>
              </div>
