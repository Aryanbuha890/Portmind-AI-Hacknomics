      ...
      <div className="mx-auto max-w-4xl px-6 py-12 md:py-20">
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-slate-600">LogiMind AI Infrastructure & Data Protection</p>
          </div>

          <div className="prose prose-invert prose-emerald max-w-none text-slate-700">
            <p>
            ...
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4 border-b border-slate-200 pb-2">1. Compliance & Certifications</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4 border-b border-slate-200 pb-2">2. Data Encryption</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4 border-b border-slate-200 pb-2">3. Access Control & Identity</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4 border-b border-slate-200 pb-2">4. Edge Device Security</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4 border-b border-slate-200 pb-2">5. Incident Response & Bug Bounty</h2>
            <p>
            ...
            <div className="bg-slate-100 p-4 rounded-xl border border-slate-200 mt-8 inline-block">
              <p className="font-semibold text-slate-900">Report a Vulnerability</p>
              <p className="text-slate-600 mt-1 mb-2 text-sm">If you believe you have found a security vulnerability, please contact us immediately.</p>
