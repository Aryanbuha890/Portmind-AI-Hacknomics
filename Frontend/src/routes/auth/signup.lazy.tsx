...
function SignupPage() {
  ...
  return (
    <div className="relative h-screen w-full bg-slate-50 text-slate-900 flex p-3 sm:p-4 md:p-6 lg:p-8 justify-center items-stretch overflow-hidden box-border">
        ...
        <div className="w-full max-w-[360px] sm:max-w-[380px] space-y-4 sm:space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-3.5">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-semibold text-slate-600 uppercase tracking-widest">Full Name</label>
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-semibold text-slate-600 uppercase tracking-widest">Confirm Password</label>
              <div className="relative">
                <input
            ...
            <div className="flex items-start gap-2.5 pt-0.5">
              <input
                ...
                className="mt-0.5 h-3.5 w-3.5 rounded border-slate-200 bg-slate-50 text-sky-600 focus:ring-0 focus:ring-offset-0 cursor-pointer accent-sky-600"
              />
              <label htmlFor="agree-terms" className="text-[10.5px] text-slate-600 leading-normal select-none cursor-pointer">
                I agree to the{" "}
                <button 
                  type="button"
      ...
      {modalType && (
        <div className="fixed inset-0 z-50 bg-slate-50/80 backdrop-blur-md flex items-center justify-center p-4">
          <div 
            className="relative w-full max-w-lg rounded-[24px] border border-slate-200 bg-gradient-to-br from-[#0c1a30] to-[#05060f] p-6 sm:p-8 shadow-2xl flex flex-col max-h-[80vh] animate-in fade-in zoom-in-95 duration-200"
          >
            {/* Modal Header */}
            <div className="flex items-center justify-between pb-4 border-b border-slate-200 shrink-0">
              ...
              <button 
                ...
                className="h-8 w-8 rounded-full border border-slate-200 bg-slate-50 text-slate-600 hover:text-white flex items-center justify-center transition-colors cursor-pointer"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar py-4 space-y-4 text-xs text-slate-700/90 leading-relaxed font-sans pr-1">
              {modalType === "terms" ? (
                <>
                  <p className="font-semibold text-slate-900">Last updated: June 22, 2026</p>
                  ...
                  <h4 className="font-bold text-slate-900 uppercase tracking-wider text-[10px] pt-2">1. Use of the Platform</h4>
                  ...
                  <h4 className="font-bold text-slate-900 uppercase tracking-wider text-[10px] pt-2">2. User Account & Operator Credentials</h4>
                  ...
                  <h4 className="font-bold text-slate-900 uppercase tracking-wider text-[10px] pt-2">3. Automated Actions & AI Suggestions</h4>
                  ...
                  <h4 className="font-bold text-slate-900 uppercase tracking-wider text-[10px] pt-2">4. Disclaimers & Limitation of Liability</h4>
                ...
                <>
                  ...
                  <h4 className="font-bold text-slate-900 uppercase tracking-wider text-[10px] pt-2">1. Information We Collect</h4>
                  ...
                  <h4 className="font-bold text-slate-900 uppercase tracking-wider text-[10px] pt-2">2. How We Use Data</h4>
                  ...
                  <h4 className="font-bold text-slate-900 uppercase tracking-wider text-[10px] pt-2">3. Data Retention & Secure Storage</h4>
                  ...
                  <h4 className="font-bold text-slate-900 uppercase tracking-wider text-[10px] pt-2">4. Third-Party Integrations</h4>
